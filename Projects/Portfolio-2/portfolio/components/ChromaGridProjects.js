...
const ChromaGrid = ({
  ...
  return (
    <div
      ...
      className={`relative m-auto  w-fit h-fit flex flex-wrap justify-center items-start  ${className}`}
      style={
        {
          "--r": `${radius}px`,
          "--x": "50%",
    ...
    >
      {data.map((c, i) => (
        ...
        >
          ...
          />
          <div className="relative z-10 flex-1  p-1 box-border " data-aos='zoom-in'>
            <Image
              src={c.image}
              alt={c.title}
              loading="lazy"
